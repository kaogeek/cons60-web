  ...
  const sectionArr = sections.map((section, index) => (
    <div id={'accordion-'+(index+1)} data-accordion-id={index+1} className="accordion accordion-collapsed flex flex-col w-full gap-1">
      <div className="w-full md:rounded-xl bg-white bg-opacity-5">
        <button onClick={() => accordionToggle(index+1)} className="w-full pt-5 px-5 grid grid-cols-2 justify-between">
          ...
          <div className="flex justify-end items-center gap-2 px-2 md:gap-5 md:px-5">
            ...
            <svg className="accordion-icon" width="49" height="49" viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="24.7529" cy="24.1987" r="24" fill="#240c00" />
